...
namespace Framework
{
    ...
    public abstract class DataTableHelperBase : MonoBehaviour, IDataProviderHelper<DataTableBase>, IDataTableHelper
    {
        ...
        public abstract bool ReadData(DataTableBase dataProviderOwner, string dataAssetName, object dataAsset,
            object userData);
        ...
        /// <param name="userData">自定义数据</param>
        /// <returns>是否读取数据成功</returns>
        public abstract bool ReadData(DataTableBase dataProviderOwner, string dataAssetName, byte[] dataBytes,
            int startIndex,
            int length,
            object userData);
        ...
        /// <param name="userData">自定义数据</param>
        /// <returns>是否解析数据成功</returns>
        public abstract bool ParseData(DataTableBase dataProviderOwner, byte[] dataBytes, int startIndex, int length,
            object userData);
