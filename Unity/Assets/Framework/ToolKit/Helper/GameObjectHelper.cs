...
namespace Framework
{
    public static class GameObjectHelper
    {
        ...
        /// <returns></returns>
        public static GameObject FindGameObject(GameObject parent, string[] subPath, int index, bool build, bool dontDestroy)
        {
            GameObject obj = null;
            if (parent == null)
            {
        ...
        public static GameObject FindGameObject(string path, bool build, bool dontDestroy)
        {
            ...
            {
                Logger.Error("Find GameObject ： path is null!!!");
                return null;
            }
