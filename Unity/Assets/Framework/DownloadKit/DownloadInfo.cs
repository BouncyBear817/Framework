namespace Framework
{
    ...
    public struct DownloadInfo
    {
        ...
        private readonly string mPriority;
        ...
        public DownloadInfo(string downloadPath, string downloadUri, string tag, string priority) : this()
        {
            mDownloadPath = downloadPath;
            mDownloadUri = downloadUri;
            mTag = tag;
        ...
        public DownloadInfo(string downloadPath, string downloadUri, string tag, string priority, object userData)
        {
            mDownloadPath = downloadPath;
            mDownloadUri = downloadUri;
            mTag = tag;
        ...
        /// 下载任务优先级
        /// </summary>
        public string Priority => mPriority;
        /// <summary>
        /// 用户自定义数据
        /// </summary>
