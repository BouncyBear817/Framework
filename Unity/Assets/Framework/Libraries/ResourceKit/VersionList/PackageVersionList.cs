...
namespace Framework
{
    ...
    public struct PackageVersionList
    {
        ...
        public PackageVersionList(string applicableVersion, string internalResourceVersion, Asset[] assets, Resource[] resources, FileSystem[] fileSystems, ResourceGroup[] resourceGroups) : this()
        {
            mIsValid = true;
        ...
        /// 资源适用的版号
        /// </summary>
        public string ApplicableVersion => mIsValid ? mApplicableVersion : throw new Exception("PackageVersionList data is invalid.");

        /// <summary>
        /// 资源的内部版本号
        /// </summary>
        public string InternalResourceVersion => mIsValid ? mInternalResourceVersion : throw new Exception("PackageVersionList data is invalid.");

        /// <summary>
        /// 资源集合
        /// </summary>
        public Asset[] Assets => mIsValid ? mAssets : throw new Exception("PackageVersionList data is invalid.");

        /// <summary>
        /// 资源集合
        /// </summary>
        public Resource[] Resources => mIsValid ? mResources : throw new Exception("PackageVersionList data is invalid.");

        /// <summary>
        /// 文件系统集合
        /// </summary>
        public FileSystem[] FileSystems => mIsValid ? mFileSystems : throw new Exception("PackageVersionList data is invalid.");

        /// <summary>
        /// 资源组集合
        /// </summary>
        public ResourceGroup[] ResourceGroups => mIsValid ? mResourceGroups : throw new Exception("PackageVersionList data is invalid.");
