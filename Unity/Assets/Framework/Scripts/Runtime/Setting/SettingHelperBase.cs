...
namespace Framework.Runtime
{
    ...
    public abstract class SettingHelperBase : MonoBehaviour, ISettingHelper
    {
        ...
        public abstract bool GetBool(string settingName, bool defaultValue = false);
        ...
        public abstract int GetInt(string settingName, int defaultValue = 0);
        ...
        public abstract float GetFloat(string settingName, float defaultValue = 0f);
        ...
        public abstract string GetString(string settingName, string defaultValue = null);
        ...
        /// <typeparam name="T">对象类型</typeparam>
        /// <returns>读取的对象</returns>
        public abstract T GetObject<T>(string settingName, T defaultValue);
        ...
        /// <typeparam name="T">对象类型</typeparam>
        public abstract void SetObject<T>(string settingName, T value);
        ...
        /// <param name="defaultValue">指定的游戏配置项不存在，使用默认值</param>
        /// <returns>读取的对象</returns>
        public abstract object GetObject(Type objectType, string settingName, object defaultValue);
        ...
        /// <param name="settingName">指定的游戏配置项名称</param>
        /// <param name="value">写入的对象</param>
        public abstract void SetObject(string settingName, object value);
    }
}