...
namespace Runtime
{
    ...
    {
        /// <summary>
        /// 序列化可更新模式版本资源列表（版本0）回调函数
        /// </summary>
        /// <param name="stream">指定流</param>
        /// <param name="versionList">可更新模式版本资源列表（版本0）</param>
        /// <returns>是否成功序列化可更新模式版本资源列表（版本0）</returns>
        ...
        /// <summary>
        /// 序列化可更新模式版本资源列表（版本1）回调函数
        /// </summary>
        /// <param name="stream">指定流</param>
        /// <param name="versionList">可更新模式版本资源列表（版本1）</param>
        /// <returns>是否成功序列化可更新模式版本资源列表（版本1）</returns>
        ...
        /// <summary>
        /// 序列化可更新模式版本资源列表（版本2）回调函数
        /// </summary>
        /// <param name="stream">指定流</param>
        /// <param name="versionList">可更新模式版本资源列表（版本2）</param>
        /// <returns>是否成功序列化可更新模式版本资源列表（版本2）</returns>
